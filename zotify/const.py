...
AUDIOBOOK_URL = BASE_URL + AUDIOBOOKS
...
API_CREDENTIALS_LOCATION = 'API_CREDENTIALS_LOCATION'
FETCH_DELAY = 'FETCH_DELAY'
ESCALATING_DELAY = 'ESCALATING_DELAY'
REDIRECT_TIMEOUT = 'REDIRECT_TIMEOUT'
SKIP_BY_ISRC = 'SKIP_BY_ISRC'
